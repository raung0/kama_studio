...
fn effect(
    ...
    // Angular field controls how quickly distance from the POI reaches full aberration. Smaller
    // fields make the effect ramp more aggressively, matching camera/VR-style aberration controls.
