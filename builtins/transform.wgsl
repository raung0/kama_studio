...
fn effect(
    ...
    // Scale is centered on source media. Anchor changes rotation pivot only; position places source
    // center in canvas coordinates regardless of source dimensions.
